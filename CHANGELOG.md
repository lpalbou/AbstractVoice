...
### Fixed
- Published documentation URL metadata now points to the active GitHub Pages custom-domain path at `https://www.lpalbou.info/AbstractVoice/`.

## [0.8.3] - 2026-05-06

### Added
- MkDocs Material configuration for the default documentation site.
