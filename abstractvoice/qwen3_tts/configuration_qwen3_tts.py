...
# upstream file: qwen_tts/core/models/configuration_qwen3_tts.py
...
#   1. layer_type_validation / rope_config_validation routed through abstractvoice._hf_compat (4.57 helpers deprecated/removed across transformers 5.x).
#   2. Qwen3TTSSpeakerEncoderConfig accepts **kwargs and calls super().__init__() so 5.x save/load round trips work.
...
from .._hf_compat import layer_type_validation, rope_config_validation
